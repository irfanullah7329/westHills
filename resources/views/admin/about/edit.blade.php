        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-title"><strong>Edit About </strong></p>
                    <!-- <h4 class="card-title" style="float:right;">View All</h4> -->
                    <p class="card-description">
                        <!-- Create User -->
                    </p>
                    <form class="form-sample" action="{{ route('admin.about.update', $about->id) }}" method="post">
                        @csrf
                        @method('put')
                        <p class="card-description">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="title" id="title"
                                            value="{{ old('title',$about->title) }}" class="form-control" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        rows="10" cols="50"  value="" required > {{ old('description',$about->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
