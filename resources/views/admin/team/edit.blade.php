        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.team.list')}}" style="float:right;">Show all</a>
                    <p class="card-title"><strong>Edit Team</strong></p>
                    <!-- <h4 class="card-title" style="float:right;">View All</h4> -->
                    <p class="card-description">
                        <!-- Create User -->
                    </p>
                    <form class="form-sample" action="{{ route('admin.team.update', $team->id) }}" method="post" enctype="multipart/form-data" >
                        @csrf
                        @method('put')
                        <p class="card-description">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="title" id="title"
                                            value="{{ old('title',$team->title) }}" class="form-control" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        rows="10" cols="50"  value="" required > {{ old('description',$team->description) }} </textarea>
                                    </div>
                                </div>
                            </div>
