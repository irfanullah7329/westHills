        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-title"><strong>Add New </strong></p>
                    <!-- <h4 class="card-title" style="float:right;">View All</h4> -->
                    <p class="card-description">
                        <!-- Create User -->
                    </p>
                    <form class="form-sample" action="{{ route('admin.portfolio.store') }}" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="technology" id="technology"
                                            value="{{ old('technology') }}" class="form-control" required />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        rows="10" cols="50" placeholder="Description here" value="{{ old('description') }}" class="form-control" required > </textarea>
                                    </div>
                                </div>
                            </div>
